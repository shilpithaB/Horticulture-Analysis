...
plot_ly(df, labels = ~df$STATES, values = ~df$`2011-2012(P)`, type = 'pie') %>%
   layout(title = 'Total Plantation Production in 2011-2012',
...
plot_ly(df, labels = ~df$STATES, values = ~df$`2012-2013(P)`, type = 'pie') %>%
  layout(title = 'Total Plantation  Production in 2012-2013',
...
plot_ly(df, labels = ~df$STATES, values = ~df$`2013-2014(P)`, type = 'pie') %>%
  layout(title = 'Total Plantation Area and Production in 2013-2014',
         xaxis = list(showgrid = FALSE, zeroline = FALSE, shoticklabels = FALSE),
         yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
......................................................................................
...
plot_ly(df, labels = ~df$STATES, values = ~df$`2011-2012(Yield_Hort(P))`, type = 'pie') %>%
  layout(title = 'Total Plantation Yield_Hort in 2011-2012(Production)',
         xaxis = list(showgrid = FALSE, zeroline = FALSE, shoticklabels = FALSE),
         yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
.......................................................................................

#..........Total Plantation Yield_Hort in 2012-2013(Production).......................
plot_ly(df, labels = ~df$STATES, values = ~df$`2012-2013(Yield_Hort(P))`, type = 'pie') %>%
  layout(title = 'Total Plantation Yield_Hort in 2012-2013(Production)',
         xaxis = list(showgrid = FALSE, zeroline = FALSE, shoticklabels = FALSE),
         yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
.......................................................................................


#..........Total Plantation Yield_Hort in 2013-2014(Production).......................
plot_ly(df, labels = ~df$STATES, values = ~df$`2013-2014(Yield_Hort(P))`, type = 'pie') %>%
  layout(title = 'Total Plantation Yield_Hort in 2013-2014(Production)',
         xaxis = list(showgrid = FALSE, zeroline = FALSE, shoticklabels = FALSE),
         yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE))
.......................................................................................


#..........Total Plantation % change in 2013-2014 over 2012-2013(Production).......................
...
#..........Total Plantation  % change in 2012-2013 over 2011-2012(Production).......................
